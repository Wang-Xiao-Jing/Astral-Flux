...
public class AttributeRegister {
  ...
  @NotNull
  protected static DeferredHolder<Attribute, Attribute> register(String name, double defaultValue, double minValue, double maxValue) {
  ...
  @NotNull
  protected static DeferredHolder<Attribute, Attribute> register(String name, double minValue, double maxValue) {
    return register(name, minValue, minValue, maxValue);
  }

  @NotNull
  protected static DeferredHolder<Attribute, Attribute> register(String name, boolean defaultValue) {
